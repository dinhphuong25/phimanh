    ...
    <button onClick={handleClick} className="block h-full w-full text-left group">
      <div className="relative h-full w-full overflow-hidden rounded-lg sm:rounded-xl bg-gray-900 shadow-md transition-all duration-300 hover:shadow-xl hover:shadow-red-600/20 hover:-translate-y-1">
        ...
        <div className="absolute top-1.5 left-1.5 sm:top-2 sm:left-2 z-20">
          <span className="bg-red-600 text-white text-[8px] sm:text-[10px] font-bold px-1.5 sm:px-2 py-0.5 rounded shadow-md">
            {movie.quality || "HD"}
          </span>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 z-20">
          <h3 className="font-semibold sm:font-bold text-white text-[10px] sm:text-xs md:text-sm line-clamp-2 leading-tight mb-0.5 sm:mb-1 group-hover:text-red-400 transition-colors duration-300">
            {movie.name}
          </h3>
          <div className="flex items-center justify-between text-[8px] sm:text-[10px] md:text-xs text-gray-400">
