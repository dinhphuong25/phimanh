      ...
      <div className={`fixed left-0 top-0 bottom-0 w-80 bg-white dark:bg-gray-900 shadow-xl z-50 transform transition-transform duration-300 overflow-y-auto ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
        ...
        <nav className="p-4 space-y-4">
          ...
          <div>
            <Link
              href="/"
              className={`flex items-center space-x-3 p-3 rounded-lg transition-colors ${isActiveLink("/")
          ...
          <div>
            <Link
              href="/new-updates"
              className={`flex items-center space-x-3 p-3 rounded-lg transition-colors ${isActiveLink("/new-updates")
                ? "bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400"
                : "hover:bg-gray-100 dark:hover:bg-gray-800"
                }`}
              ...
              <div className="ml-8 mt-2 space-y-1">
                {categories.map((cat) => (
                  <Link
                    ...
                    className={`block p-2 text-sm rounded-md transition-colors ${isActiveCategory(cat.slug)
